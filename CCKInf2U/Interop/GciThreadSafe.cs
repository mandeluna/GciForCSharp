...
// NOTE(AB): Unix and X509 methods omitted

/// <summary>
/// gcits.hf
/// </summary>
internal static unsafe partial class GciThreadSafe
{
	/// <summary>
	/// Full name of the GciTs DLL.
	/// </summary>
	//private const string GciTsDLL = "libgcits-3.6.6-64.dll";
	...
	public struct GciTsObjInfo
	{
		...
		public GciTsObjInfo()
		{
			objId = GciOop.OOP_NIL;
			objClass = GciOop.OOP_NIL;
			objSize = 0;
			namedSize = 0;
			access = 0;
		...
		internal enum BitsMask : ushort
		{
			...
			swiz_kind_shift = 8, // NOTE(AB): This feels very sus, but matches definition.
		}
	}
...
#pragma warning disable S1939 // Inheritance list should not be redundant - Explicitly stated for interop.
	public enum GciEventType : int
#pragma warning restore S1939 // Inheritance list should not be redundant - Explicitly stated for interop.
	{
		gciSigNone,
		gciSigAbort,
		gciSigCommittedObjs,
	...
	public static partial int64 GciTsFetchObjInfo(
		...
		// TODO(AB): Behaviour of methods changes if `buffer` is NULL... Not always a span.
		// Vaguely remember there's  way to marshal a span -> NULL to mirror existing behaviour,
		// can't find it again currently though...
		ByteType* buffer,
		size_t bufSize,
		ref GciErrSType err);
	...
	/// </remarks>>
	[LibraryImport(GciTsDLL)]
	public static partial int GciTsNbPoll(GciSession session, int timeoutMs, ref GciErrSType err);
	...
	#region Methods - Unnecessary or Undocumented
	...
	*/
	...
	#endregion Methods - Unnecessary or Undocumented
}
